...
export default {
  ...
  popover_padding_multiplier: Option(1.0, {
    'category': 'General',
  ...
  color: {
    red: Option('#fa4d56', { 'scss': 'red' }),
    green: Option('#42be65', { 'scss': 'green' }),
    yellow: Option('#fddc69', { 'scss': 'yellow' }),
    blue: Option('#4589ff', { 'scss': 'blue' }),
    magenta: Option('#be95ff', { 'scss': 'magenta' }),
    teal: Option('#3ddbd9', { 'scss': 'teal' }),
    orange: Option('#ff832b', { 'scss': 'orange' }),
  },
  ...
  font: {
    font: Option('Berkeley Mono', {
      'type': 'font',
      'title': 'Font',
      'scss': 'font',
    }),
    mono: Option('Berkeley Mono', {
